...
if (isset($_POST['submit'])) {
    ...
    if (count($errors) == 0) {
        ...
        $msj .= '<p>' . $mensaje . '</p>';
        $msj .= "--<p>Este mensaje se ha enviado desde un formulario de contacto de Familia de Dios.</p>";
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'nuctua1@gmail.com';
            $mail->Password = 'Amores3945';
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
            $mail->Port = 465;

            $mail->setFrom('nuctua1@gmail.com', 'Ruben');
            $mail->addAddress('familiadediosf@gmail.com', 'Receptor');
    ...
    <main>
        <div class="container py-3">
            ...
            <footer class="pt-3 mt-4 text-muted border-top">
                Familia de dios Filadelfia &copy; 2021
            </footer>
